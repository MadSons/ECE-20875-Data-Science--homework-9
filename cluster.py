...
class Cluster:
    ...
    def avgDistance(self):
        ...
        Returns:
          ...
          to self.center.
        """
        return sum([self.center.distFrom(point) for point in self.points]) / len(self.points)
    ...
    def updateCenter(self):
        ...
        if len(self.points):
            self.center = Point([sum(x)/len(x) for x in zip(*self.points)]) # zip(*points) unzips the list of points
